...
<label><input id='dht-cfg-animemoji' type='checkbox'> Animated Emoji</label><br>`);
	...
	const showInfoModal = function() {
		...
		showModal(560, `
<p>DHT was originally developed by <a href='https://chylex.com'>chylex</a> as an <a href='https://github.com/chylex/Discord-History-Tracker/blob/master/LICENSE.md'>open source</a> project.</p>
<p>The DHT Internal variant was developed by the <a href="https://github.com/IntelligenceTaskForce">Intelligence Task Force</a>, making it more suitable for intelligence reconnaissance.</p>
<p><a href='https://github.com/IntelligenceTaskForce/DHT-Internal/issues'>Issue Tracker</a> &nbsp;&mdash;&nbsp; <a href='https://github.com/IntelligenceTaskForce/DHT-Internal'>GitHub Repository</a>`);
	};
